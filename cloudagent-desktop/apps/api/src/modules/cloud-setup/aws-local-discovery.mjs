...
import { refineLocalWorkloadDiscoveryWithOpenAI } from "../../platform/local-openai.mjs";
...
export async function listLocalAwsProfiles() {
...
export async function validateLocalAwsCredentials({ authProfile, region } = {}) {
