import { executeLocalWorkflow } from "../runners/plan-runner.mjs";
...
export function startWorkflowScheduler({ store, pollIntervalMs } = {}) {
  if (!store) throw new Error("startWorkflowScheduler requires a store");
