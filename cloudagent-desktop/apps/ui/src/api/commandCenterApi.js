...
const COMMAND_CENTER_BASE = BACKEND_API_ENDPOINT;
const commandCenterUrl = (path) =>
  getRuntimeApiUrl(path, { fallbackApiBaseUrl: COMMAND_CENTER_BASE });
...
async function buildAuthHeaders() {
  ...
  try {
    ...
    console.warn('[commandCenterApi] Failed to fetch auth session:', error);
  }
  return {};
}
