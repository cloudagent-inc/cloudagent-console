...
function normalizeBlueprintCloudProvider(value) {
  const normalized = String(value || DEFAULT_SKILL_BUILDER_CLOUD_PROVIDER).trim().toLowerCase();
              ...
              {setupStep === 'planType' ? (
                <>
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    {SKILL_BUILDER_PLAN_TYPES.map((opt) => (
                      <button
                        key={opt.value}
                        type="button"
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <span className="min-w-0 flex-1">
                            <span className="flex flex-wrap items-center gap-2">
                              ...
                              <span className={`rounded-full border px-2.5 py-0.5 text-[11px] font-semibold uppercase tracking-wide ${opt.safetyClassName}`}>
                                {opt.safetyLabel}
                              </span>
                            </span>
                ...
                <>
                  <div className="space-y-3">
                    ...
                    <Textarea
                      ...
                      rows={4}
                      placeholder="E.g. Review our AWS Backup readiness for DynamoDB tables"
