  ...
  const onSetupComplete = async (completeSetupData) => {
    ...
    try {
      ...
      const selectedExecutionMode = isLocalMode && isBlueprint
        ? normalizeBlueprintRunMode(completeSetupData.executionMode || completeSetupData.runner || 'cloudagent')
        : 'cloudagent';
      ...
      {showRunModal && (
        <SettingsSummary
          ...
          onSubmit={(settings, environmentContext = {}) => {
            ...
            const nextExecutionMode = normalizeBlueprintRunMode(
              environmentContext.executionMode ||
                environmentContext.runner ||
