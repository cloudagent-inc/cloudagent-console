...
export default function MCPPage() {
  ...
  const applyRuntimeInfo = useCallback((info) => {
    ...
    // Prefer the server-supplied tokenized MCP URL so copy/paste into external
    // MCP clients carries the auth token. Fall back to the plain base URL.
    if (info.mcpUrl) {
      setMcpServerUrl(info.mcpUrl);
    } else if (info.apiBaseUrl) {
