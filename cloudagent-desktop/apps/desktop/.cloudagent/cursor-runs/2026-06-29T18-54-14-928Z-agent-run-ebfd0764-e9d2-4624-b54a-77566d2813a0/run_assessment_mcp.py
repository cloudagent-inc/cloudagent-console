...
MCP_URL = "http://127.0.0.1:65013/mcp?cloudagentRunId=agent-run-ebfd0764-e9d2-4624-b54a-77566d2813a0&cloudagentRunner=cursor"
...
OUT = "/Users/abdul/dev/cloudagent/cloudagent-desktop/apps/desktop/.cloudagent/cursor-runs/2026-06-29T18-54-14-928Z-agent-run-ebfd0764-e9d2-4624-b54a-77566d2813a0/aws-backup-assessment.json"
...
def main():
    ...
    all_non_success = b_non + r_non + c_non
    ...
    result = {
        ...
        "summary": {
            ...
            "totalNonSuccessJobs": len(all_non_success),
            "allJobsSuccessful": not all_non_success,
            "nonSuccessByType": {"backup": len(b_non), "restore": len(r_non), "copy": len(c_non)},
            "allNonSuccessJobs": all_non_success,
        },
    }
