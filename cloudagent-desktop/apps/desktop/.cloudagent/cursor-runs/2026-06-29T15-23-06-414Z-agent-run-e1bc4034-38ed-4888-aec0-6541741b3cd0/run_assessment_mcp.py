...
MCP_URL = "http://127.0.0.1:63361/mcp"
PROFILE = "profile-8b000c93-6acb-4492-b87f-138db43b6c7e"
ACCOUNT = "025825898506"
REGION = "us-east-1"
START = "2026-05-30T15:23:14Z"
END = "2026-06-29T15:23:14Z"
...
def paginate(session_id, service, list_key):
    ...
    while True:
        cmd = (
            ...
            f"--by-created-after {START} --by-created-before {END} "
...
def main():
    ...
    out = "/Users/abdul/dev/cloudagent/cloudagent-desktop/apps/desktop/.cloudagent/cursor-runs/2026-06-29T15-23-06-414Z-agent-run-e1bc4034-38ed-4888-aec0-6541741b3cd0/aws-backup-assessment.json"
